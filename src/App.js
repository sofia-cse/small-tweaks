...
function App() {
  return (
    <div className="">
        <Navbar bg="light" expand="" className="fixed-top">
        ...
        <div className="case-study">
          <Container>
            ...
            <Row>
              <Col><img src={avinewComparison} alt="avinew-comparison" width={1013} className="overflowing" /></Col>
            </Row>
            <Row>
        ...
        <div className="case-study">
          <Container>
            ...
            <Row>
              <Col><img src={n2uitiveComparison} alt="n2uitive-comparison" width={1230} className="overflowing" /></Col>
            </Row>
            <Row>
              <Col className="roi georgia text-center">
        ...
        <div className="case-study">
          <Container>
            ...
            <Row>
              <Col><img src={firesideComparison} alt="fireside-comparison" width={1230} className="overflowing" /></Col>
            </Row>
            <Row>
              <Col className="roi georgia text-center">
        ...
        <div style={{paddingTop: 98, paddingBottom: 70}} id="testimonials">
          <Container>
            <Row>
              <Col className="text-center"><img src={n2uitiveQuote} alt="quote" /></Col>
            </Row>
            <Row style={{paddingTop: 29, paddingBottom: 28}}>
              <Col className="text-center"><img src={avinewQuote} alt="quote" /></Col>
            </Row>
            <Row>
              <Col className="text-center"><img src={firesideQuote} alt="quote" /></Col>
            </Row>
          </Container>
        </div>
          ...
          <Container id="contact">
              ...
              <Row className="contact-boxes text-center">
                <Col sm>
                  ...
                  <p className="mx-auto contact-button">Go</p>
                </Col>
                <Col sm>
